    ...
    public String storeItem_and_Imges() {
        ...
        try {
	     ...
	     fileInputStream.read(bFile1);
             fileInputStream=(FileInputStream) file2.getInputstream();
	     fileInputStream.read(bFile2);
             fileInputStream=(FileInputStream) file3.getInputstream();
	     fileInputStream.read(bFile3);
             fileInputStream=(FileInputStream) file4.getInputstream();
	     fileInputStream.read(bFile4);
             fileInputStream=(FileInputStream) file5.getInputstream();
